    ...
    return (
        <div>
            ...
            <StyledHug
                ...
                text={
                    <div>
                        <Text.span mr={429} bold>EXPRESS DEAL</Text.span>
                        <Text.span ml={10} mr={1} bold>Save $111!</Text.span>
                ...
                <Card p={3}>
                    ...
                    <Text.span fontSize={1} bold>05/09</Text.span>
                    <Text.span mx={4} fontSize={1} bold>JFK - SEA</Text.span>
                    ...
                    <Text.span fontSize={1} bold>05/13</Text.span>
                    <Text.span mx={4} fontSize={1} bold>SEA - JFK</Text.span>
            ...
            <StyledCard
                ...
                <Card borderWidth={0}>
                    <Text.span mx={45} fontSize={1} bold>05/09</Text.span>
                    <Text.span ml={116} fontSize={1} normal>JFK</Text.span>
                    <Text.span ml={94} fontSize={1} normal>SEA</Text.span>
                ...
                <Card borderWidth={0}>
                    <Text.span mx={45} fontSize={1} bold>05/09</Text.span>
                    <Text.span ml={123} fontSize={1} normal>SEA</Text.span>
                    <Text.span ml={93} fontSize={1} normal>JFK</Text.span>
            ...
            <StyledCard
                ...
                <Card borderWidth={0}>
                    <Text.span mx={45} fontSize={1} bold>05/09</Text.span>
                    <Text.span ml={121} fontSize={1} normal>JFK</Text.span>
                    <Text.span ml={93} fontSize={1} normal>SEA</Text.span>
                ...
                <Card mt={1} borderWidth={0}>
                    ...
                    <Text.span mr={1} fontSize={1}>----------------</Text.span>
                    <Text.span mr={1} fontSize={1} bold>1:10p</Text.span>
                    <Text.span ml={102} fontSize={1} normal>2 Stops</Text.span>
                </Card>
                <Card borderWidth={0}>
                    <Text.span mx={45} fontSize={1} bold>05/09</Text.span>
                    <Text.span ml={123} fontSize={1} normal>SEA</Text.span>
                    <Text.span ml={94} fontSize={1} normal>JFK</Text.span>
